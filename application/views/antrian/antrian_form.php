<div class="container-fluid">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Form tambah antrian
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="<?= base_url('antrian/insert') ?>">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" name="jam_antrian" class="form-control" id="">
                            </div>
